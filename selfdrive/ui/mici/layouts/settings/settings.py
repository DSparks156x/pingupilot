...
from openpilot.selfdrive.ui.mici.layouts.settings.pingulink import PingulinkLayoutMici
...
class SettingsLayout(NavScroller):
  def __init__(self):
    ...
    pingulink_panel = PingulinkLayoutMici()
    pingulink_btn = SettingsBigButton("pingulink", "", gui_app.texture("icons_mici/settings.png", 64, 64))
    pingulink_btn.set_click_callback(lambda: gui_app.push_widget(pingulink_panel))
