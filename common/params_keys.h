...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ShowTamagotchi", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    // --- pingulink params --- //
    {"PingulinkEnable", {PERSISTENT, BOOL, "0"}},
    {"PingulinkUrl", {PERSISTENT, STRING}},
    {"PingulinkToken", {PERSISTENT | DONT_LOG, STRING}},
    {"PingulinkLastPing", {PERSISTENT, STRING}},
    {"PingulinkLastPingStatus", {PERSISTENT, STRING}},
    {"PingulinkPendingCount", {PERSISTENT, STRING}},
    ...
    {"VolkswagenHCAMode", {PERSISTENT | BACKUP, INT, "1"}},
    {"VolkswagenHCADeltaRateUp", {PERSISTENT | BACKUP, INT, "0"}},
    {"VolkswagenHCADeltaRateDown", {PERSISTENT | BACKUP, INT, "0"}},
    {"VolkswagenHCACenteringFullAuthority", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"VolkswagenHCALatJerkFactor", {PERSISTENT | BACKUP, INT, "0"}},
    {"VolkswagenHCALatAccelFactor", {PERSISTENT | BACKUP, INT, "15"}},
